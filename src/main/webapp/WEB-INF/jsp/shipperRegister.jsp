<%-- 
    Document   : shipperRegister
    Created on : Sep 3, 2022, 4:07:56 PM
    Author     : Admin
--%>
...
<div class="container1">
    <h1 class="text-center">THÊM SHIPPER</h1>
        ...
        <c:url value="/admin/shipperRegister" var="action"/>
        <div class="container">
            <form:form method="post" action="${action}" modelAttribute="shipper" 
                ...
                <div class="form-group">
                    ...
                    <form:input type="text" id="cmnd" path="cmnd" class="form-control"/>
                </div>
                <div class="form-group">
